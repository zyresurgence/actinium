package com.zy.actinium.rabbitmq.consumer.constants;
...
public class RabbitMessageQueueConstants {
    ...
    public static final String NAME_KEY_QUEUE_TOPIC = "mail.routing.topic.demo";
    public static final String NAME_KEY_QUEUE_HEADERS = "mail.routing.headers.demo";
